...
4.0 scale with +/- increments, where an A+ earns 4.33:

| A+ | A | A- | B+ | B | B- | C+ | C | C- | D+ | D | D- | F |
|----|---|----|----|---|----|----|---|----|----|---|----|---|
| 4.33 | 4.0 | 3.7 | 3.3 | 3.0 | 2.7 | 2.3 | 2.0 | 1.7 | 1.3 | 1.0 | 0.7 | 0.0 |
...
The weighted GPA is shown to three decimals, the unweighted to two. Because an A+ is 4.33,
the maximums are 4.33 unweighted and 5.33 weighted.
...
and the meters all read from those two tables. Decimal places are set by `PRECISION`.
